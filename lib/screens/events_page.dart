                ...
                itemBuilder: (context, index) {
                  ...
                  return StreamBuilder<DocumentSnapshot>(
                    ...
                    builder: (context, eventsSnapshot) {
                      if (eventsSnapshot.hasData && eventsSnapshot.data?.data() != null) {
                        Map<String, dynamic> data = eventsSnapshot.data?.data() as Map<String, dynamic>;
              ...
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  actions: [
                    ...
                    TextButton(
                      onPressed: () {
                        firestoreService.deleteEvent(document.id);
